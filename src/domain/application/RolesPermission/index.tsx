        ...
        return (
            <section className="tab-container row vertical-tab-container">
                <Nav tabs className="pl-3 pl-3 mb-4 mt-4 col-sm-2">
                    <Rbac parentName="xformation-rbac-ui-plugin" childName="Permissions">
                    ...
                    <Rbac parentName="xformation-rbac-ui-plugin" childName="Roles">
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName="xformation-rbac-ui-plugin" childName="Groups">
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName="xformation-rbac-ui-plugin" childName="Users">
                        <NavItem className="cursor-pointer">
