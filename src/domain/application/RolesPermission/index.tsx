        ...
        return (
            <section className="tab-container row vertical-tab-container">
                <Nav tabs className="pl-3 pl-3 mb-4 mt-4 col-sm-2">
                    <Rbac parentName={config.PARENT_NAME} childName="rolepermission-index-permissions">
                    ...
                    <Rbac parentName={config.PARENT_NAME} childName="rolepermission-index-roles">
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName={config.PARENT_NAME} childName="rolepermission-index-groups">
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName={config.PARENT_NAME} childName="rolepermission-index-users">
                        <NavItem className="cursor-pointer">
