        ...
        return (
            <section className="tab-container row vertical-tab-container">
                <Nav tabs className="pl-3 pl-3 mb-4 mt-4 col-sm-2">
                    <Rbac parentName={'Permissions'} childName={'Permissions'}>
                    ...
                    <Rbac parentName={'Roles'} childName={'Roles'}>
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName={'Groups'} childName={'Groups'}>
                        <NavItem className="cursor-pointer">
                    ...
                    <Rbac parentName={'Users'} childName={'Users'}>
                        <NavItem className="cursor-pointer">
